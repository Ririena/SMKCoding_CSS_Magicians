...
import PurchaseStepCard from "./components/PurchaseCard"; // Sesuaikan dengan path yang benar
...
interface Product {
  ...
  description: string;
  image: string;
  defaultRating: number; // Tambahkan prop defaultRating ke dalam interface Product
}
...
const products: Product[] = [
  {
    ...
    defaultRating: 3, // Tambahkan nilai default rating untuk produk
  },
  {
    id: 2,
    name: "Kopi Robusta",
    ...
    defaultRating: 4, // Tambahkan nilai default rating untuk produk
  },
  {
    id: 3,
    name: "Kopi Piccolo",
    ...
    defaultRating: 5, // Tambahkan nilai default rating untuk produk
  },
];
      ...
      <div data-aos="fade-up">
        ...
        >
          <div className="container">
            ...
            >
              <div className="row">
                <Slider className="text-black d-grid gap-4" {...settings}>
...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
  const [rating, setRating] = React.useState<number>(product.defaultRating); // Mengatur nilai default rating
